...
Public Class RptRtn
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_xNet() As CrystalDecisions.[Shared].IParameterField
        Get
