...
Public Class SupPayments
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POS_System.SupPayments.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_xSUPNAME() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_xCURBAL() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedSupPayments
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SupPayments = New SupPayments()
        rpt.Site = Me.Site
        Return rpt
    End Function
