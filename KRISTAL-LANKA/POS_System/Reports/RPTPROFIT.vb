...
Public Class RPTPROFIT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POS_System.RPTPROFIT.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_xsls() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_xcst() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPTPROFIT
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTPROFIT = New RPTPROFIT()
        rpt.Site = Me.Site
        Return rpt
    End Function
