...
Public Class RptCreditTaken
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POS_System.RptCreditTaken.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCreditTaken
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCreditTaken = New RptCreditTaken()
        rpt.Site = Me.Site
        Return rpt
    End Function
