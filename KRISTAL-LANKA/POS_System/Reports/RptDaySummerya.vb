...
Public Class RptDaySummerya
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POS_System.RptDaySummerya.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_xDT() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptDaySummerya
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptDaySummerya = New RptDaySummerya()
        rpt.Site = Me.Site
        Return rpt
    End Function
